...
$known = @(
    ...
    @{ name = "commons-lang"; url = "https://github.com/apache/commons-lang";      sha = "29ccc7665f3bc5d84155a3092ab2209a053324e6" },
    @{ name = "csvhelper";    url = "https://github.com/JoshClose/CsvHelper";      sha = "5dad8b8b1d8b074f8353cfd482e939db788a8927" }
)
foreach ($k in $known) {
